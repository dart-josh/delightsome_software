...
class ProductMaterialsRequestModel {
  String? key;
  String? recordId;
  DateTime? recordDate;
  ...
  // get model from json
  factory ProductMaterialsRequestModel.fromJson(Map json) {
    return ProductMaterialsRequestModel(
      key: json['_id'],
