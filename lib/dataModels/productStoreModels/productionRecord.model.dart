...
class ProductionRecordModel {
  ...
  // get model from json
  factory ProductionRecordModel.fromJson(Map json) {
    return ProductionRecordModel(
      ...
      verifiedDate: json['verifiedDate'] != null
          ...
          : null,
      producer: json['producer'] != null ? StaffModel.fromJson(json['producer']) : null,
  ...
  Map enter_toJson({required String producer, required String editedBy}) => {
        'id': key,
