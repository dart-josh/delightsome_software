...
class TerminalCollectionRecordModel {
  String? key;
  String? recordId;
  DateTime? recordDate;
  ...
  // get model from json
  factory TerminalCollectionRecordModel.fromJson(Map json) {
    return TerminalCollectionRecordModel(
      key: json['_id'],
