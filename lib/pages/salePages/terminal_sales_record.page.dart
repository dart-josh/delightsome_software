...
class TerminalSalesRecordPage extends StatefulWidget {
  const TerminalSalesRecordPage({super.key});

  @override
  State<TerminalSalesRecordPage> createState() =>
      _TerminalSalesRecordPageState();
}

class _TerminalSalesRecordPageState extends State<TerminalSalesRecordPage> {
  ...
  get_record() {
    List<SalesModel> all_record =
        Provider.of<AppData>(context).terminal_sales_record;
                ...
                if (auth_staff!.fullaccess)
                  IconButton(
                      onPressed: () async {
                        ...
                        if (res != null) {
                          if (res == 'delete') {
                            SaleHelpers.delete_terminal_sale_record(
                                context, record.key!);
                          }
