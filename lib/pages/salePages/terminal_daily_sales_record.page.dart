...
class TerminalDailySalesRecordPage extends StatefulWidget {
  const TerminalDailySalesRecordPage({super.key});

  @override
  State<TerminalDailySalesRecordPage> createState() =>
      _TerminalDailySalesRecordPageState();
}

class _TerminalDailySalesRecordPageState
  ...
  get_record() {
    all_record = Provider.of<AppData>(context).terminal_daily_sales_record;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // content
          Expanded(
            child: TerminalDailySaleRecordView(
  ...
  Widget view_record_by_date(
    ...
    return FutureBuilder<List<TerminalDailySalesModel>>(
      ...
      future: records.isNotEmpty
          ? null
          : (date != null && isOffList)
              ? SaleHelpers.get_selected_terminal_daily_sales_record(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: TerminalDailySaleRecordView(record: s_rec),
                    ),
                  ),
                ),
              ],
