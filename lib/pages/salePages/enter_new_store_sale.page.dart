...
class _StoreSalesPageState extends State<StoreSalesPage> {
  ...
  get_products() {
    ...
    shops = Provider.of<AppData>(context).store_shops;
  }
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: (width < 800) ? null : 15,
            right: (width < 800) ? 15 : null,
              ...
              IconButton(
                  onPressed: () async {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => StoreSalesRecordPage()));
                  },
                  icon: Icon(
                    Icons.list,
                    color: Colors.white,
