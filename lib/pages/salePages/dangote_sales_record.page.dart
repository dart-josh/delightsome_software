...
class DangoteSalesRecordPage extends StatefulWidget {
  const DangoteSalesRecordPage({super.key});

  @override
  State<DangoteSalesRecordPage> createState() =>
      _DangoteSalesRecordPageState();
}

class _DangoteSalesRecordPageState extends State<DangoteSalesRecordPage> {
  ...
  get_record() {
    List<SalesModel> all_record =
        Provider.of<AppData>(context).dangote_sales_record;
                ...
                if (auth_staff!.fullaccess)
                  IconButton(
                      onPressed: () async {
                        ...
                        if (res != null) {
                          if (res == 'delete') {
                            SaleHelpers.delete_dangote_sale_record(
                                context, record.key!);
                          }
