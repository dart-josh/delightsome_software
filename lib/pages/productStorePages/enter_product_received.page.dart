...
class EnterProductReceivedPage extends StatefulWidget {
  final ProductReceivedRecordModel? editModel;
  const EnterProductReceivedPage({super.key, this.editModel});

  @override
  State<EnterProductReceivedPage> createState() =>
      _EnterProductReceivedPageState();
}

class _EnterProductReceivedPageState extends State<EnterProductReceivedPage> {
  ...
  void get_edit_values() {
    if (widget.editModel != null) {
      ...
      supplier = widget.editModel!.supplier;
    }
  }
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_products.isNotEmpty) {
                    var prrm = ProductReceivedRecordModel(
                    ...
                    if (widget.editModel?.key == null) {
                      saved_product_received_model = prrm;
                    }
                  } else {
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (res != null) {
                      ...
                      if (widget.editModel?.key == null) {
                        var prrm_s = ProductReceivedRecordModel(
                          products: selected_products,
                          shortNote: shortNote,
                          receiver: staff,
                          supplier: supplier,
