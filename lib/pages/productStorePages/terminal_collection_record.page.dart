...
class _TerminalCollectionRecordPageState
  ...
  get_record() {
    List<TerminalCollectionRecordModel> all_record =
    ...
    groups.forEach((key, value) {
      GroupedTerminalCollectionRecordModel val =
          GroupedTerminalCollectionRecordModel(date: key, record: value);
  ...
  // date picker tile
  Widget date_picker_tile(GroupedTerminalCollectionRecordModel record) {
    bool isDarkTheme =
        Provider.of<AppData>(context).themeMode == ThemeMode.dark;
  ...
  // record view
  Widget record_view(List<TerminalCollectionRecordModel> _record) {
    ...
    return Container(
      child: _record.isNotEmpty
          ? StickyGroupedListView(
              ...
              elements: _record,
              groupBy: (TerminalCollectionRecordModel element) =>
                  UniversalHelpers.get_date(element.recordDate!),
              groupComparator: (DateTime value1, DateTime value2) =>
                  value2.compareTo(value1),
              groupSeparatorBuilder: (TerminalCollectionRecordModel element) =>
                  group_separator(element.recordDate!),
              itemBuilder: (context, TerminalCollectionRecordModel element) =>
                  record_tile(element),
  ...
  // record tile
  Widget record_tile(TerminalCollectionRecordModel record) {
    bool isDarkTheme =
        Provider.of<AppData>(context).themeMode == ThemeMode.dark;
    ...
    TextStyle collection_style = TextStyle(
      color: record.collectionType == 'Collected' ? Colors.green : Colors.red,
      fontWeight: FontWeight.w500,
      fontSize: 12,
    );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // collection type
                Text(record.collectionType, style: collection_style),
  ...
  Widget view_record_by_date(
    ...
    List<TerminalCollectionRecordModel> records = [];
    ...
    return FutureBuilder<List<TerminalCollectionRecordModel>>(
      initialData: records,
...
class GroupedTerminalCollectionRecordModel {
  List<TerminalCollectionRecordModel> record;
  DateTime date;

  GroupedTerminalCollectionRecordModel({
