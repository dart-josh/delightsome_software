...
class EnterProductRequestPage extends StatefulWidget {
  final ProductRequestRecordModel? editModel;
  const EnterProductRequestPage({super.key, this.editModel});

  @override
  State<EnterProductRequestPage> createState() =>
      _EnterProductRequestPageState();
}

class _EnterProductRequestPageState extends State<EnterProductRequestPage> {
  ...
  void get_edit_values() {
    if (widget.editModel != null) {
      ...
      staff = widget.editModel!.requestedBy;
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_products.isNotEmpty) {
                    var prrm = ProductRequestRecordModel(
                    ...
                    if (widget.editModel?.key == null) {
                      saved_product_request_model = prrm;
                    }
                  } else {
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (res != null) {
                      ...
                      if (widget.editModel?.key == null) {
                        var prrm_s = ProductRequestRecordModel(
                          products: selected_products,
                          shortNote: shortNote,
                          requestedBy: staff,
                        );
