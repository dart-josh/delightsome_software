...
class EnterBadProductPage extends StatefulWidget {
  final BadProductRecordModel? editModel;
  const EnterBadProductPage({super.key, this.editModel});

  @override
  State<EnterBadProductPage> createState() => _EnterBadProductPageState();
}

class _EnterBadProductPageState extends State<EnterBadProductPage> {
  ...
  void get_edit_values() {
    if (widget.editModel != null) {
      ...
      staff = widget.editModel!.staffResponsible;
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_products.isNotEmpty) {
                    var bprm = BadProductRecordModel(
                  ...
                  onTap: () async {
                    ...
                    var res = await showDialog(
                      ...
                      builder: (context) => SelectStaffDialog(
                        staff_label: 'Select staff responsible',
                        note_label: 'Short note',
                        staff: staff,
                        note: shortNote,
                        date: widget.editModel?.recordDate,
                        staff_list_type: 'Production, Sales, Terminal, Dangote',
                      ),
                    );
                    ...
                    if (res != null) {
                      ...
                      if (widget.editModel?.key == null) {
                        var bprm_s = BadProductRecordModel(
                          products: selected_products,
                          shortNote: shortNote,
                          staffResponsible: staff,
                        );
