...
class EnterProductTakeOutPage extends StatefulWidget {
  final ProductTakeOutRecordModel? editModel;
  const EnterProductTakeOutPage({super.key, this.editModel});

  @override
  State<EnterProductTakeOutPage> createState() =>
      _EnterProductTakeOutPageState();
}

class _EnterProductTakeOutPageState extends State<EnterProductTakeOutPage> {
  ...
  void get_edit_values() {
    if (widget.editModel != null) {
      ...
      staff = widget.editModel!.takenBy;
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_products.isNotEmpty) {
                    var ptrm = ProductTakeOutRecordModel(
                    ...
                    if (widget.editModel?.key == null) {
                      saved_product_takeOut_model = ptrm;
                    }
                  } else {
                    saved_product_takeOut_model = null;
                  }
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (res != null) {
                      ...
                      if (widget.editModel?.key == null) {
                        var ptrm_s = ProductTakeOutRecordModel(
                          products: selected_products,
                          shortNote: shortNote,
                          takenBy: staff,
                        );
                        saved_product_takeOut_model = ptrm_s;
                      }
