...
class DangoteCollectionRecordPage extends StatefulWidget {
  const DangoteCollectionRecordPage({super.key});

  @override
  State<DangoteCollectionRecordPage> createState() =>
      _DangoteCollectionRecordPageState();
}
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Center(
            child: Text(
              title ?? 'Dangote Collection Record',
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('Dangote Staff : ', style: label_style),
                    SizedBox(width: 4),
                ...
                onPressed: () async {
                  ...
                  if (res != null) {
                    ...
                    if (res == 'Verify') {
                      ...
                      ProductStoreHelpers.verify_dangoteCollection_record(
                          context,
                    ...
                    if (res == 'edit') {
                      ...
                      if (width > 600) {
                        showDialog(
                            ...
                            builder: (context) => EnterDangotecollectionPage(
                                  editModel: record,
                    ...
                    if (res == 'delete') {
                      ProductStoreHelpers.delete_dangoteCollection_record(
                          context, record.key!);
                    }
                  }
                },
  ...
  Widget view_record_by_date(
    ...
    return FutureBuilder<List<DangoteCollectionRecordModel>>(
      ...
      future: records.isNotEmpty
          ? null
          : (date != null && isOffList)
              ? ProductStoreHelpers.get_selected_dangoteCollection_record(
              ...
              : (month != null && isOffList)
                  ...
                  : (dateRange != null && isOffList)
                      ? ProductStoreHelpers
                          .get_selected_dangoteCollection_record(context, {
                          'timeFrame': [
