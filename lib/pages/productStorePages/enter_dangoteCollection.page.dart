...
class EnterDangotecollectionPage extends StatefulWidget {
  ...
  @override
  State<EnterDangotecollectionPage> createState() =>
      _EnterDangotecollectionPageState();
}

class _EnterDangotecollectionPageState
    extends State<EnterDangotecollectionPage> {
    ...
    return Container(
      ...
      child: Stack(
        children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_products.isNotEmpty) {
                    ...
                    if (widget.collectionType == 'Collected') {
                      saved_dangote_collected_model = null;
                    } else {
          ...
          Center(
            child: Text(
              'Enter Dangote ${widget.collectionType} Record',
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
                  ...
                  onTap: () async {
                    ...
                    var res = await showDialog(
                      ...
                      builder: (context) => SelectStaffDialog(
                        staff_label: 'Select dangote staff',
