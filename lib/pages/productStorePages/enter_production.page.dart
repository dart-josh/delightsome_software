...
class EnterProductionPage extends StatefulWidget {
  final ProductionRecordModel? editModel;
  const EnterProductionPage({super.key, this.editModel});

  @override
  State<EnterProductionPage> createState() => _EnterProductionPageState();
}

class _EnterProductionPageState extends State<EnterProductionPage> {
  ...
  void get_edit_values() {
    if (widget.editModel != null) {
      ...
      staff = widget.editModel!.producer;
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (res != null) {
                      ...
                      if (widget.editModel?.key == null) {
                        var prm_s = ProductionRecordModel(
                          products: selected_products,
                          shortNote: shortNote,
                          producer: staff,
                        );
