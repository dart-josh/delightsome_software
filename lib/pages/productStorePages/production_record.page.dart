...
class _ProductionRecordPageState extends State<ProductionRecordPage> {
  ...
  List<ProductionRecordModel> pending_record = [];
    ...
    return Container(
      child: _record.isNotEmpty
          ? StickyGroupedListView(
              ...
              elements: _record,
              groupBy: (ProductionRecordModel element) =>
                  UniversalHelpers.get_date(element.recordDate!),
              groupComparator: (DateTime value1, DateTime value2) =>
                  value2.compareTo(value1),
              groupSeparatorBuilder: (ProductionRecordModel element) =>
                  group_separator(element.recordDate!),
              itemBuilder: (context, ProductionRecordModel element) =>
                  record_tile(element),
  ...
  // record tile
  Widget record_tile(ProductionRecordModel record) {
    bool isDarkTheme =
        Provider.of<AppData>(context).themeMode == ThemeMode.dark;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text('Producer : ', style: label_style),
                    SizedBox(width: 4),
                    Text(record.producer?.nickName ?? 'No Staff',
                        style: main_style),
                    Expanded(child: Container()),
                ...
                onPressed: () async {
                  ...
                  if (res != null) {
                    ...
                    if (res == 'Verify') {
                      ...
                      ProductStoreHelpers.verify_production_record(
                          context,
                    ...
                    if (res == 'delete') {
                      ProductStoreHelpers.delete_production_record(
