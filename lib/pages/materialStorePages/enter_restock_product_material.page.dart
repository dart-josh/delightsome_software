...
class EnterRestockProductMaterial extends StatefulWidget {
  final RestockProductMaterialModel? editModel;
  const EnterRestockProductMaterial({super.key, this.editModel});

  @override
  State<EnterRestockProductMaterial> createState() =>
      _EnterRestockProductMaterialState();
}

class _EnterRestockProductMaterialState
    extends State<EnterRestockProductMaterial> {
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_items.isNotEmpty) {
                    var rpmm = RestockProductMaterialModel(
                    ...
                    if (widget.editModel?.key == null) {
                      saved_restock_product_material_model = rpmm;
                    }
                  } else {
            ...
            child: InkWell(
              onTap: () async {
                ...
                if (res != null) {
                  ...
                  if (widget.editModel?.key == null) {
                    var rpmm_s = RestockProductMaterialModel(
                      items: selected_items,
                      shortNote: shortNote,
                      receiver: staff,
                    );
