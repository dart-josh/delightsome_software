...
class EnterProductMaterialRequest extends StatefulWidget {
  final ProductMaterialsRequestModel? editModel;
  const EnterProductMaterialRequest({super.key, this.editModel});

  @override
  State<EnterProductMaterialRequest> createState() =>
      _EnterProductMaterialRequestState();
}

class _EnterProductMaterialRequestState
    extends State<EnterProductMaterialRequest> {
              ...
              InkWell(
                onTap: () {
                  ...
                  if (selected_items.isNotEmpty) {
                    var pmrm = ProductMaterialsRequestModel(
                    ...
                    if (widget.editModel?.key == null) {
                      saved_product_material_request_model = pmrm;
                    }
                  } else {
            ...
            child: InkWell(
              onTap: () async {
                ...
                if (res != null) {
                  ...
                  if (widget.editModel?.key == null) {
                    var pmrm_s = ProductMaterialsRequestModel(
                      items: selected_items,
                      purpose: purpose,
                      receiver: staff,
                    );
                    saved_product_material_request_model = pmrm_s;
                  }
                  ...
                  bool done = await MaterialStoreHelpers
                      .enter_product_materials_request_record(context, map);
